...
import employeeApi from "../../services/api/employee/employeeApi"; // Adjust the import path
import { getTodayValues } from "../presence/PresenceFormModal";
const PlanningFormModal = ({ isOpen, onClose, onSubmit, initialData }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl max-h-[80vh] overflow-y-auto relative z-50">
        ...
        <h2 className="text-2xl font-bold mb-6">
          {initialData ? "Edit Planning" : "Add Planning"}
        </h2>
